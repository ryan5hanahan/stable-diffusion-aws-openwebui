...
async def list_models_openai():
    """OpenAI-compatible models endpoint - required for OpenWebUI connection validation"""
    return {
        "object": "list",
        "data": [
            {
            ...
            },
            {
                ...
                "owned_by": "stability-ai",
                "permission": [],
                "root": "stability.sd3-5-large-v1:0",
                "parent": None,
            },
            {
                ...
                "owned_by": "stability-ai",
                "permission": [],
                "root": "stability.stable-image-core-v1:1",
                "parent": None,
            },
            {
                ...
                "owned_by": "stability-ai",
                "permission": [],
                "root": "stability.stable-image-ultra-v1:1",
                "parent": None,
            },
        ]
    }
...
async def chat_completions(request: ChatCompletionRequest):
    """
    Handle chat completions by generating an image from the last user message.
    This allows OpenWebUI to use the proxy as a 'chat' model that responds with images.
    """
    ...
    try:
        ...
        # Return as a chat completion with the image embedded in markdown
